...
-- saveState/loadState/applyDefLocks are defined at load time.
-- They only reference `snd` at call time (when the user actually saves/loads),
-- so they don't need `snd` to exist at definition time.
